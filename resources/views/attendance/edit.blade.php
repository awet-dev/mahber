                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('attendances.update', ['attendance' => $attendance->id]) }}">
                        ...
                        <div class="mb-4">
                            ...
                            >{{ old('description', $attendance->description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="attended_at" class="block mt-1 w-full"
                                          type="date"
                                          value="{{ old('attended_at', $attendance->attended_at->toDateString()) }}"
                                          name="attended_at"/>
                        ...
                        <div class="flex items-center justify-start mt-4 gap-2">
                            ...
                            <label for="attended" class="inline-flex items-center">
                                ...
                                <input id="attended" type="checkbox"
                                       @if(($errors->isEmpty() && $attendance->attended) || old('attended')) checked
                                       @endif
